...
const HeaerTopRow = (props) => {
  return (
    <section className="top-row">
      <IconButton href="#" title="Facebook" target="_blank">
        <FaFacebookF size="18" className="white-icon" />
      </IconButton>
      <IconButton href="#" title="Twitter" target="_blank">
        <FaTwitter size="18" className="white-icon" />
      </IconButton>
      <IconButton href="#" title="Intagram" target="_blank">
        <FaInstagram size="18" className="white-icon" />
      </IconButton>
      <IconButton href="#" title="Linked In" target="_blank">
        <FaLinkedin size="18" className="white-icon" />
      </IconButton>
      <IconButton href="#" title="Contact Us">
        ...
        {!userPermissions.login ? (
          <Hidden xsDown>
            ...
            <Link to="/registration" className={"link"}>
              <Button variant="contained" className="primary-btn-red">
                Register
              </Button>
            </Link>
          </Hidden>
          ...
          <div>
            {userPermissions.rights !== "visitor" &&
