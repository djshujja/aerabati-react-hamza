...
class Routes extends React.Component {
  componentDidMount() {
    ...
    if (token !== "" && !userPermissions.login) {
      axios
        .get(verifyTokenUrl, { headers: { token: token } })
        .then((res) => {
      ...
      <BrowserRouter>
        <Switch>
          <Route
            path="/active-cars"
            extact
            component={AuthenticatedComponent(ActiveCars)}
          />
          <Route
            path="/add-products"
            extact
            component={AuthenticatedComponent(AddProducts)}
          />
          <Route
            path="/edit-products/:id"
            extact
            component={AuthenticatedComponent(EditProducts)}
          />
          <Route
            path="/showroom"
            extact
            component={AuthenticatedComponent(ShowRoom)}
          />{" "}
          {/* like users */}
          <Route
            path="/addshowroom"
            extact
            component={AuthenticatedComponent(Addshowroom)}
          />{" "}
          {/* like users */}
          <Route
            path="/leads"
            extact
            component={AuthenticatedComponent(Leads)}
          />{" "}
          {/* like users */}
          <Route
            path="/users"
          ...
          <Route
            path="/user-edit/:id"
            component={AuthenticatedComponent(UserEdit)}
          />
          {/*<Route path="/user-settings/:id"  component={AuthenticatedComponent(UserEdit)}/>*/}
          <Route
            path="/dealership-info/:id"
            component={AuthenticatedComponent(DealerShipInfo)}
          />
          <Route
            exact
            path="/dealership"
            component={AuthenticatedComponent(DealerShip)}
          />
          <Route
            exact
            path="/activecars"
          ...
          <Route
            exact
            path="/stats"
            component={AuthenticatedComponent(Stats)}
          />
