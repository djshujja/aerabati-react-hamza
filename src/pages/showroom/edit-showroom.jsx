...
import { editSpecificProduct,updateProducts,allshowrooms } from '../../assets/serverUrls';
...
class Editshowroom extends React.Component {
   constructor(props){
    ...
    componentDidMount(){
       ...
       axios.get(`https://aerbeti-bck-test.herokuapp.com/api/showrooms/`+this.id)
       .then(res=>{
           const data = (res.data);
   ...
   handleChange(e){
    ...
    handleSubmit(e){
       ...
       console.log(formData)
        axios.post(allshowrooms+`/updateshowroom/`+this.id, formData, {
      }).then(res => {
                    ...
                    <div className="container" style={{margin:20}}>
                        <form onSubmit={this.handleSubmit} encType="multipart/form-data">
                            ...
                            <FormControl fullWidth={true}>
                                ...
                                <Input value={this.state.email} name="email" id="email" aria-describedby="my-helper-text"
                                       onChange={
                                           this.handleChange
                                       }
                                />
                            ...
                            <FormControl fullWidth={true}>
                                ...
                                <Input value={this.state.address} name="address" id="address" aria-describedby="my-helper-text"
                                       onChange={
                                           this.handleChange
                                       }
                                />
